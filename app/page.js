...
export default function Home() {
  return (
    <main className="w-full h-screen pt-0 pl-28 md:pl-52">
      <div className="grid items-center justify-center h-full gap-4 p-5 text-center md:grid-cols-2">
        <div className="flex flex-col p-2">
          ...
          <span className="p-1 text-sm text-start">
            ...
            components. With WindTails, you can access a wide range of pre-built
            components that are easy to use and fully customizable. Our website
            offers an open source and free collection of Tailwind CSS
            components, making it a go-to resource for building stunning web
            pages quickly and efficiently. Whether you are looking to build a
            blog, e-commerce site, or landing page, WindTails has got you
            covered with its extensive collection of beautifully designed
